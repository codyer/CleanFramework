 ...
 * from Hyphenate Inc.
 */
package com.cody.app.business.easeui.model;
...
import com.cody.app.business.easeui.EaseUI;
import com.cody.app.business.easeui.EaseUI.EaseSettingsProvider;
...
//        vibrateAndPlayTone(message);
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(appContext, PUSH_CHANNEL_ID)
            ...
            if (notificationInfoProvider != null) {
                if (notificationInfoProvider.getLaunchIntent(message) != null) {
            ...
            crc32.update(message.conversationId().getBytes());
            //int mNotifyId = Long.valueOf(crc32.getValue()).intValue();
            notifyID = Long.valueOf(crc32.getValue()).intValue();

            if (isForeground) {
                String topActivityName = EasyUtils.getTopActivityName(appContext);
                boolean isChatActivity = ChatActivity.class.getName().equals(topActivityName);
