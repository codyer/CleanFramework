 ...
 */
public abstract class ListWithHeaderBasePresenter<ListHeaderViewModel extends ListWithHeaderViewModel<ItemViewModel>,
        ItemViewModel extends XItemViewModel> extends AbsListPresenter<ListHeaderViewModel, ItemViewModel> {
}
