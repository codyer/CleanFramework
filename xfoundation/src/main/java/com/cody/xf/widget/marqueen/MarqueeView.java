...
public class MarqueeView extends ViewFlipper {
    ...
    private void initAnimation() {
        clearAnimation();
        Animation animIn = AnimationUtils.loadAnimation(mContext, R.anim.xf_anim_marquee_in);
        setInAnimation(animIn);
        Animation animOut = AnimationUtils.loadAnimation(mContext, R.anim.xf_anim_marquee_out);
