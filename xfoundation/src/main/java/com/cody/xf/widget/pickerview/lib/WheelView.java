package com.cody.xf.widget.pickerview.lib;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.xf_picker_view_wheel_view_text_color_out);
        textColorCenter = getResources().getColor(R.color.xf_picker_view_wheel_view_text_color_center);
        dividerColor = getResources().getColor(R.color.xf_picker_view_wheel_view_text_color_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.xf_picker_view_text_size);
        customTextSize = getResources().getBoolean(R.bool.xf_picker_view_custom_text_size);
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.xf_picker_view, 0, 0);
            mGravity = a.getInt(R.styleable.xf_picker_view_xf_picker_view_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.xf_picker_view_xf_picker_view_text_color_out, textColorOut);
            textColorCenter = a.getColor(R.styleable.xf_picker_view_xf_picker_view_text_color_center, textColorCenter);
            dividerColor = a.getColor(R.styleable.xf_picker_view_xf_picker_view_divider_color, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.xf_picker_view_xf_picker_view_text_size, textSize);
        }
