package com.cody.xf.widget.tablayot;
...
//        updateTabStyles();
    ...
    private void addTab(final int position, View view){
        ...
        view.setTag(R.id.xf_tab_tag_position, position);
    ...
    class PageOnClickListener implements OnClickListener{
        ...
        public void onClick(View view) {
            int tag = (int)view.getTag(R.id.xf_tab_tag_position);
    ...
    public void setSelectItem(int position){
        ...
        for (int i = 0; i < tabsContainer.getChildCount(); i++) {
            ...
            view.setTag(R.id.xf_tab_tag_position, i);
